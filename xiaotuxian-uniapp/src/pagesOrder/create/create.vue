  ...
  <scroll-view class="viewport" scroll-y>
    ...
    <view class="settlement">
      <view class="item">
        ...
        <text class="number symbol">{{ orderPre?.summary.totalPayPrice }}</text>
      </view>
      <view class="item">
...
const selectAddress = computed(() => {
  return addressStore.seletedAddress || orderPre.value?.userAddresses.find((v) => v.isDefault)
})
